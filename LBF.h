...
void LoadOpencvBbxData(int flags,
					   std::string path,
					   std::string filepath,
                       std::vector<cv::Mat_<uchar> >& images,
                       std::vector<cv::Mat_<double> >& ground_truth_shapes,
...
void TrainDemo( std::string path );
double TestDemo( std::string path );
int FaceDetectionAndAlignment(std::string path, const char* inputname);
