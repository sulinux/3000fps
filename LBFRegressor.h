...
public:
    ...
    void Write(std::string path,std::ofstream& fout);
    void Load(std::string path , std::string name);
    void Save(std::string path,std::string curpath);
    ...
    void WriteRegressor(std::string Rpath,std::ofstream& fout);
    void ReadRegressor(std::string path,std::ifstream& fin);
